...
function App() {
  ...
  const [isLoading, userPlaces, setUserPlaces, error] = useFetch(
    fetchUserPlaces,
    [],
  );
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    setUserPlaces((prevPickedPlaces) => {
      return addPlace(prevPickedPlaces, selectedPlace);
    });

    try {
      await updateUserPlaces(addPlace(userPlaces, selectedPlace));
    } catch (error) {
